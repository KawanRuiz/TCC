    ...
    <body  >
        ...
        <div class="menu">
            ...
            <div >
                ...
                <%if (comandas != null && comandas.isStatus_dia() == true) {
                ...
                <table  class="table table-hover" >
                    ...
                    <tfoot >
                        <tr>
                            <td> <a  class="btn btn-danger" href="ComandasServlet?oper=FecharDia"><i class="bi bi-x-circle"></i> Fechar o Dia</a></td>
                        </tr>
                    </tfoot>
                    ...
                    <tbody >
                        ...
                        <tr >
                            ...
                            <td></td>
                            <td ><font face="arial"><%out.print(c.getNomeComanda());%></td>

                            <td><%out.print(c.getDataComanda());%></td>
                            <td><%if (c.isStatus() == true) {%> Aberta <%} else {%> Fechada <%} %></td>



                            <td>

                                <a class='btn btn-outline-dark btn-sm' href='ComandasServlet?idComanda=<%out.print(c.getIdComanda());%>&oper=AbrirComanda'><i class="bi bi-plus-circle"></i> Abrir Comanda</a>
                        ...
                        <tr > 
                            <td></td>
                            <td> <a href="ComandasServlet?oper=NovaComanda" class="btn btn-primary"><i class="bi bi-clipboard-plus"></i><span> Nova Comanda</span></a></td>
                            <td></td>
                            <td></td>
                            <td></td
                            <td></td>
